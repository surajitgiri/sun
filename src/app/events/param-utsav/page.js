...
export default function ParamUtsavPage() {
    ...
    <div className="adv-page-root">
      ...
      <section className="adv-hero">
        ...
        <div className="adv-hero-content">
          ...
          <h1 className="adv-title">Param Utsav</h1>
          <p className="adv-sub">
            The grand annual celebration of life and awakening. Join thousands of seekers in this powerful, joyful gathering of the Param Mitras.
          </p>
      ...
      <section className="adv-section" style={{ textAlign: 'center', paddingBottom: '120px' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', maxWidth: '600px', margin: '0 auto 40px', lineHeight: 1.6 }}>Get ready for the biggest spiritual gathering of the year. Music, celebration, and immense energy await you.</p>
