...
export default function SwadikshaPage() {
    ...
    <div className="adv-page-root">
      ...
      <section className="adv-hero">
        ...
        <div className="adv-hero-content">
          <div className="adv-tag">Special Annual Event</div>
          <h1 className="adv-title">Swadiksha Event</h1>
          <p className="adv-sub">
            The profound annual self-initiation ceremony. Once in a year opportunity to ignite your inner flame under the direct aura of Pujya Param Aalay Ji.
          </p>
      ...
      <section className="adv-section" style={{ textAlign: 'center', paddingBottom: '120px' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', maxWidth: '600px', margin: '0 auto 40px', lineHeight: 1.6 }}>By registering, you commit your presence to this profound annual event. We invite you to experience what living fully alive truly means.</p>
