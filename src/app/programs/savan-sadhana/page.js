...
export default function SavanSadhanaPage() {
    ...
    <div className="adv-page-root">
      ...
      <section className="adv-hero">
        ...
        <div className="adv-hero-content">
          ...
          <h1 className="adv-title">11 Days Savan Sadhna</h1>
          <p className="adv-sub">
            A special monsoon retreat to dive into deep meditation and natural healing while the earth rejuvenates itself.
          </p>
