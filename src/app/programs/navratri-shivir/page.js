...
export default function NavratriShivirPage() {
    ...
    <div className="adv-page-root">
      ...
      <section className="adv-hero">
        ...
        <div className="adv-hero-content">
          ...
          <h1 className="adv-title">11 Days Param Navratri</h1>
          <p className="adv-sub">
            An 11-day residential camp for deep mind awakening and spiritual growth during the auspicious peak cosmic energy of Navratri.
          </p>
      ...
      <section className="adv-section" style={{ textAlign: 'center', paddingBottom: '120px' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', maxWidth: '600px', margin: '0 auto 40px', lineHeight: 1.6 }}>By registering, you agree to totally surrender to the routine for 11 days. We invite you to experience what living fully alive truly means.</p>
