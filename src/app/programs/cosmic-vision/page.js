...
export default function CosmicVisionPage() {
    ...
    <div className="adv-page-root">
      ...
      <section className="adv-hero">
        ...
        <div className="adv-hero-content">
          ...
          <h1 className="adv-title">18 Days Cosmic Vision</h1>
          <p className="adv-sub">
            The extraordinary 18-day profound journey to rewrite your life equations and achieve limitless potential. Exclusively designed for seasoned seekers.
          </p>
      ...
      <section className="adv-section" style={{ textAlign: 'center', paddingBottom: '120px' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', maxWidth: '600px', margin: '0 auto 40px', lineHeight: 1.6 }}>By registering, you agree to totally surrender to the routine for 18 days. We invite you to experience what living fully alive truly means.</p>
